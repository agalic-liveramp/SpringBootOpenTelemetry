...
public class DemoApplication {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    //System.setProperty("otel.exporter.otlp.endpoint", "http://otel-agent.demo:4317");
    //System.setProperty("otel.resource.attributes", "service.name=OtlpDemoTestv2");

    OpenTelemetry openTelemetry = OpenTelemetrySdkAutoConfiguration.initialize();

    tracer = openTelemetry.getTracer("demo-test");
...
//      parentSpan.setAttribute("VALUE", "TEST");
